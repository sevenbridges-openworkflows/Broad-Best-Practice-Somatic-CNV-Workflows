...
- sbg:modifiedBy: stefan_stojanovic
  ...
  sbg:revision: 16
  sbg:revisionNotes: change label in benchmarking table, experimental strategy instead
    of sequencing data
- sbg:modifiedBy: stefan_stojanovic
...
- sbg:modifiedBy: stefan_stojanovic
  ...
  sbg:revision: 22
  sbg:revisionNotes: add descriptions for memory_per_job, memory overhead and cpu
    per job
- sbg:modifiedBy: stefan_stojanovic
  sbg:modifiedOn: 1553170553
  sbg:revision: 23
  sbg:revisionNotes: fix extensions in description to be uppercase; add more supported
    intervals formats
- sbg:modifiedBy: stefan_stojanovic
...
- sbg:modifiedBy: stefan_stojanovic
  ...
  sbg:revision: 30
  sbg:revisionNotes: change in_alignments input file to array of files, and set to
    required; fix output naming expression accordingly; fix description to reflect
    changes
- sbg:modifiedBy: stefan_stojanovic
...
- sbg:modifiedBy: stefan_stojanovic
  ...
  sbg:revision: 34
  sbg:revisionNotes: change back choices for output_format to uppercase; fix glob
    expressions to catch uppercase extensions
- sbg:modifiedBy: stefan_stojanovic
...
- sbg:modifiedBy: stefan_stojanovic
  ...
  sbg:revision: 37
  sbg:revisionNotes: fix expression for entity_id output eval, allow for list output
    as well as single entity id string output
- sbg:modifiedBy: stefan_stojanovic
  sbg:modifiedOn: 1559307568
  sbg:revision: 38
  sbg:revisionNotes: edit entity_id output eval expression, always output array of
    strings
- sbg:modifiedBy: stefan_stojanovic
...
- sbg:modifiedBy: stefan_stojanovic
  ...
  sbg:revision: 40
  sbg:revisionNotes: fix entity_id output eval expression, allow for zero length in_alignments
    case, in case of conditional execution
- sbg:modifiedBy: stefan_stojanovic
